...
export default function MyApp({ Component, pageProps }) {
    ...
    return (
        ...
        <Head>
            ...
            <meta name="description" content="Página de presentaciones para la materia de estructura de datos" />
            ...
            <title>{`Estructura de Datos ${currentClass ? `| ${currentClass.title}` : '' }`}</title>
