            ...
            <Row>
                <Col col={7}>
                    <Box pr={5}>
                        ...
                        >
                            <H1 shadow>
                                Las Hash Tables están ampliamente presentes en
                        ...
                        >
                            ...
                            <GlassCard mt={4} whiteStyle>
                                <GlassCardContent whiteStyle>
                                    <p>
                                        Podemos encontrarlas a lo largo de
                                        varios lenguajes bajo distintos nombres,
                                        sin embargo, en (casi) todos son
                                        prácticamente lo mismo.
                                        <br />
                                        <br />
                                        Entender su teoría nos ayudará a
                                        comprender como se usan sin importar en
                                        que lenguaje de programación estemos
                                        trabajando.
                                    </p>
                                </GlassCardContent>
                            </GlassCard>
