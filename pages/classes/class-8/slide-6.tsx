            ...
            <Row>
                <Col col={12}>
                    <Box pr={5}>
                        ...
                        >
                            <H1 shadow>Métodos de las Listas Doblemente Enlazadas</H1>
                        </motion.div>
                    </Box>
                    <Box>
                        <motion.div
                        ...
                        >
                            ...
                            <GlassCard mt={4} whiteStyle>
                                <GlassCardContent whiteStyle>
                                    <p>
                                        Los métodos no varían con respecto a los de las listas enlazadas simples,
                                        sin embargo, las implementaciones están adaptadas al hecho de
                                        que se tiene que manejar un apuntador más por cada nodo.
                                        <ul
                                            style={{
                                                columns: 2,
                                                marginTop: "1rem",
