...
const dataTypes = [
    {
        ...
        content: (
            <>
                Los nodos de la lista enlazada se guardan aleatoriamente en la
    ...
    },
    {
        ...
        content: (
            <>
                Los nodos de la lista doblemente enlazada funcionan basicamente
        ...
        <Container>
            <Row>
                <Col col={6}>
                    ...
                    >
                        <H1 shadow>Veamoslo desde el punto de vista de memoria</H1>
                    </motion.div>
                    <Box mt={4} pr={3}>
                        <motion.div
                            initial="hidden"
