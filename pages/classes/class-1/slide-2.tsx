                ...
                <Col col={6} xs={6}>
                    ...
                    <GlassCard>
                        <motion.div  initial='hidden' animate={controls} variants={variants} custom={2} transition={transition}>
                            ...
                            tiempo parcial en el departamento de Gestión de Proyectos y Sistemas. Además trabajo como desarrollador en Continuum Health Technologies y Aether Solutions.
                            <br/>
                            <br/>
