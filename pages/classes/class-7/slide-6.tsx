            ...
            <Row>
                <Col col={7}>
                    <Box pr={5}>
                        ...
                        >
                            <H1 shadow>Anatomía de una Lista Enlazada</H1>
                        </motion.div>
                    </Box>
                    <Box pr={5}>
                        <motion.div
                        ...
                        >
                            ...
                            <GlassCard mt={4} whiteStyle>
                                <GlassCardContent
                                    whiteStyle
                                    style={{ maxHeight: "100%", padding: "0rem" }}
                                >
                                    <p>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <b>Tamaño (opcional): </b> para poder saber el largo de nuestra lista.
                                            </li>
                                        </ul>
