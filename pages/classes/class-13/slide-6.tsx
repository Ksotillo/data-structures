            ...
            <Row>
                <Col col={7}>
                    <Box pr={5}>
                        ...
                        >
                            <H1 shadow>Ejemplo de representación de una clase</H1>
                        </motion.div>
                    </Box>
                    <Box pr={5}>
                        <motion.div
                        ...
                        >
                            ...
                            <GlassCard mt={4} whiteStyle>
                                <GlassCardContent whiteStyle>
                                    <p>
                                        El siguiente ejemplo es la representación de una clase "Animal"
                                        en un diagrama UML, con dos atributos privados y sus métodos
                                        públicos.
                                    </p>
                                </GlassCardContent>
                            </GlassCard>
